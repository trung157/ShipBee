...
public class XacnhanlayhangAction extends ActionSupport{
	...
	public String execute() throws Exception {
		...
		dataList = a.getDondanhan(lid,sid);
		if (dataList != null) {
			return SUCCESS;
		}
		return ERROR;
	...
	public String layhang() throws Exception{
		ShipperBO s = new ShipperBO();
		if (s.UpdateLayhang(Integer.parseInt(request.getParameter("iddonhang"))) == true) {
			request2.put("thongbao", "Lấy hàng thành công");
			dataList = s.getDondanhan(lid,sid);
			return SUCCESS;
		} else {

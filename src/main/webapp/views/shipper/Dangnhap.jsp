...
<body>
	...
	<div class="page-inside">
		...
		<div class="login-box">
			...
			<div class="form">
				<form id="frm" action="dangnhapshipper" method="POST">
					<div class="form-group">
						<label class="reg">Tên đăng nhập</label> <input
							type="text" class="form-control input-lg" name="sdt"
					...
					<div class="login-forgot"> <a href="Quenmatkhauship.jsp">Quên
							mật khẩu?</a>
							</div>
				</form>
			</div>
			...
			<div class="login-social">
				...
				<div class="login-signup">
					Bạn chưa có tài khoản? <a href="DangkiShipper.jsp">Đăng kí
						ngay</a>
				</div>
			</div>
		</div>

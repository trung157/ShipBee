							...
							<div class="panel-body">
								<div class="info">
									...
									<div class="info-row">
										...
										<div class="info-text">${cusbankcard }</div>
									</div>
									<div class="info-row">
										<label>Loại xe:</label>
										<div class="info-text">${cusloaixe}</div>
									</div>
									<div class="info-row">
										<label>Biển số xe:</label>
										<div class="info-text">${cuslicenseplate }</div>
									</div>
									<div class="info-row">
										<label>Địa chỉ:</label>
				...
				<div class="modal-body">
					<div class="local-storage-destination">
						<form class="form form-horizontal" id="frmEditCustomerInfo"
							method="post" action="capnhatthongtinshipper">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" name="newstk" class="form-control"
										value="${cusbankcard }" />
								</div>
							</div>
							<div class="form-group">

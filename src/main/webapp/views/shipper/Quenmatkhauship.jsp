...
<div class="register-box">
    <div class="form local-storage-destination">
        ...
        <form id="frmRegister" action="quenmatkhauship" name="" method="post" class="form-2">
            <div class="form-group text-center">
            	<h1><p class="form-control-static">Quên Mật Khẩu</p></h1>
            </div>
            
            <div class="form-group">
                <input type="text" class="form-control"  name="sdt"  placeholder="Nhập số điện thoại đã đăng kí ()" />
            </div>
            <div class="form-group">
                <input type="text" class="form-control" name="mail"  placeholder="Số email đã đăng kí (*)" />
            </div>
            <div class="form-group">

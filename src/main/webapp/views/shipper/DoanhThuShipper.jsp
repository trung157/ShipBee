...
<%@ page import="com.test.struts2.dao.ShipperDAO"%>
<%
String dataPoints = ShipperDAO.getDoanhthuShipper((int)session.getAttribute("cusid"));
%>
...
<!-- Core CSS -->
<title>Doanh thu Shipper | Shipbee.vn</title>
<meta charset="UTF-8">
<link

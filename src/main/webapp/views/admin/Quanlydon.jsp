...
<!-- Core CSS -->
<title>Quản lý đơn | Shipbee.vn</title>
<meta charset="UTF-8">
<link rel="stylesheet"
								...
								<thead>
									<tr>
										...
										<th width="7%" class="text-left"><i class="fa fa-usd"></i>Phí
											thu hộ</th>
											<th width="12%" class="text-left"><i class="fa fa-money"></i>SĐT/Họ tên Shipper</th>
								...
								<tbody>
									<s:iterator value="listdonhang">
										<tr>
											...
											<td><s:property value="sdtshipper" /> - <s:property value="hotenshipper" /></td>

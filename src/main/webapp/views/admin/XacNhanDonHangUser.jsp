...
<!-- Core CSS -->
<title>Xác nhận đơn hàng | Shipbee.vn</title>
<meta charset="UTF-8">
<link rel="stylesheet"
							...
							<table class="table table-striped">
								<thead>
									<tr>
										...
										<th width="9%" class="text-left"><i class="fa fa-barcode"></i>Mã
											đơn hàng</th>
										<th width="10%" class="text-center"><i
											class="fa fa-archive"></i>Tên Người dùng</th>
										<th width="13%" class="text-left"><i
											class="fa fa-map-marker"></i>SĐT/Họ tên/ĐC người gửi</th>
										<th width="13%" class="text-left"><i
											class="fa fa-map-marker"></i>SĐT/Họ tên/ĐC người nhận</th>
										<th width="15%" class="text-left"><i
											class="fa fa-clock-o"></i>Thời gian tạo</th>
										<th width="7%" class="text-left"><i class="fa fa-archive"></i>Tên
											hàng</th>
										<th width="7%" class="text-left"><i class="fa fa-usd"></i>Khối
											lượng</th>
										<th width="7%" class="text-left"><i
											class="fa fa-sticky-note"></i>Ghi chú</th>
										<th width="7%" class="text-left"><i class="fa fa-money"></i>Phí
											vận chuyển</th>
										<th width="7%" class="text-left"><i class="fa fa-usd"></i>Phí
											thu hộ</th>
										<th width="7%" class="text-left"><i class="fas fa-eye"></i>Trạng
											thái</th>
										<th width="7%" class="text-left"><i class="fas fa-play"></i>Thao
											tác</th>

									</tr>
								</thead>
								<tbody>
									<s:iterator value="listdonhang">
										<tr>
											<td><s:property value="iddonhang" /></td>
											<td><s:property value="madonhang" /></td>
											<td><s:property value="hotenuser" /></td>
											<td><s:property value="sdtnguoigui" />- <s:property
													value="hotennguoigui" />- <s:property
													value="diachinguoigui" /></td>
											<td><s:property value="sdtnguoinhan" />- <s:property
													value="hotennguoinhan" />- <s:property
													value="diachinguoinhan" /></td>
											<td><s:property value="ngaytaodon" /></td>
											...
											<td><a class="text-decoration-none"
												href="xacnhandon?iddonhang=<s:property value="iddonhang"/>">
													<img width="35px" height="35px" src="https://img.icons8.com/color/48/000000/checked--v1.png"/>
											</a>
											<a class="text-decoration-none"
												href="tuchoinhandon?iddonhang=<s:property value="iddonhang"/>">
											<img width="35px" height="35px"  src="https://img.icons8.com/color/48/000000/cancel--v1.png"/>
											</a>
											</td>
										</tr>
									</s:iterator>
